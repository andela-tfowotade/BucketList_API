  ...
  describe "POST /auth/create_user" do
    context "with valid details" do
      it "creates a new user" do
        ...
        post "/api/v2/auth/create_user", valid_user_attributes
    ...
    context "with invalid details" do
      it "does not create a new user" do
        ...
        post "/api/v2/auth/create_user", invalid_user_attributes
  ...
  describe "POST /auth/login" do
    context "logging in with valid user" do
      it "displays the user's token" do
        post "/api/v2/auth/login", email: user.email, password: "password"
    ...
    context "logging in with an invalid password" do
      it "does not log user in" do
        post "/api/v2/auth/login", email: user.email,
  ...
  describe "GET /auth/logout" do
    ...
    context "when logged in" do
      context "with an authorization token" do
        it "logs the user out" do
          get "/api/v2/auth/logout", {}, Authorization: user.token
    ...
    context "when logged out" do
      it "prompts the user to sign in" do
        get "/api/v2/auth/logout", {}, Authorization: user.token
        get "/api/v2/bucketlists", {}, Authorization: user.token
