  ...
  context "as an authenticated user" do
    context "with valid attributes" do
      it "creates an item" do
        ...
        post "/api/v2/bucketlists/#{bucket.id}/items/",
    ...
    context "creating an item with an invalid bucket list id" do
      it "does not post the data" do
        ...
        post "/api/v2/bucketlists/0/items", valid_item_attributes,
  ...
  context "as an unauthenticated user" do
    context "without a token" do
      it "does not create the bucket list" do
        ...
        post "/api/v2/bucketlists/#{bucket.id}/items", valid_item_attributes
